            ...
            <div class="row row-cols-1 row-cols-md-3">
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                        <img src="<?php echo ($usuario['imagen']) ?>" class="card-img-top" alt="imagen">
                        <div class="card-body">
                            <h3 class="card-title"><?php echo ($usuario['nombre']) ?></h3>
                            <h3 class="card-title"><?php echo ($usuario['apellido']) ?></h3>
                            <h3 class="card-title"><?php if ($usuario['genero'] == "f") {
                                                            echo ("femenino");
                                                        } else {
                                                            echo ("masculino");
                                                        } ?></h3>
                            <p class="card-text"><?php echo ($usuario['descripcion']) ?></p>
                            <a href="eliminarUsuarios.php?id=<?php echo ($usuario['idUsuario']) ?>"
                                class="btn btn-dark">Elinimar</a>
                            <button type="button" class="btn btn-info" data-toggle="modal"
                                data-target="#editar<?php echo ($usuario['idUsuario'])?>">
                                Editar
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="editarUsuario.php?id=<?php echo ($usuario['idUsuario'])?>" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-warning" name="btnEditar">Enviar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
